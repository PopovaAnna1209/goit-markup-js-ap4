...
const users = [
  ...
  const getNamesSortedByFriendCount = users => [...users].sort((firstFriends, secondFriends) => firstFriends.friends.length - secondFriends.friends.length).map(user => user.name);
